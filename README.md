...
- **In-Memory Question Cache**: Loads question sets (`sets_new.json`) and answer keys directly into RAM at startup for zero disk I/O latency and microsecond API response times.
